...
namespace OnlineFruitVegShop.API.Migrations
{
    ...
    [Migration("20200526074128_UpdatedOrderClass")]
    partial class UpdatedOrderClass
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineFruitVegShop.API.Models.CartItem", b =>
                {
                    b.HasOne("OnlineFruitVegShop.API.Models.Order", null)
                        .WithMany("CartItems")
                        .HasForeignKey("OrderId");

                    b.HasOne("OnlineFruitVegShop.API.Models.Product", "Product")
                        .WithMany()
